...
namespace Microsoft.VisualStudio.ProjectSystem.DotNet.Utilities
{
    ...
    public class TextBlockFormatToHyperlinkConverter : IMultiValueConverter
    {
        ...
        // This Converter is used when we want to display a textblock containing one or more hyper links
        // Example:
        /*
        <TextBlock 
            x:Name="text_Describe"
            Grid.Row="0"
            Grid.Column="0"
            Margin="0, 10, 0, 0"
            TextWrapping="Wrap"
            ...
            <TextBlock.Tag>
                <MultiBinding Converter="{StaticResource TextBlockFormatToHyperlinkConverter}">
                    <Binding x:Name="textBlock" ElementName="text_Describe"/>
                    <Binding x:Name="formatString" Source="{x:Static Member=ui:EmaApiDefinitionEndpointDialogResources.APIDefinition_Describe}"/>
                    <Binding x:Name="hyperLink">
                        <Binding.Source>
                            <Hyperlink Command="{Binding Path=SwaggerLinkCommand}">
                                <Run Text="Swagger"/>
                            </Hyperlink>
                        </Binding.Source>
                    </Binding>
